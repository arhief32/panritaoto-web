...
<head>
	...
	<!-- //banner-slider -->
	<link rel="stylesheet" href="{{ asset('public/css/smoothbox.css') }}" type='text/css' media="all" />
	<!-- gallery lightbox -->
	<link rel="stylesheet" href="{{ asset('public/css/style.css') }}" type="text/css" media="all" />
	<!-- Style-CSS -->
	<link rel="stylesheet" href="{{ asset('public/css/fontawesome-all.css') }}">
...
<body>
					...
					<div class="col-xl-10 col-md-9 col-sm-8 col-6 logo">
						<h1>
							<a href="{{ url('/') }}">
								<!-- <span>C</span>ar
								<span>S</span>ervices -->
								<img class="image-logo" src="{{ asset('public/images/LOGO.png') }}" />
							</a>
						</h1>
					</div>
		...
		<div class="container py-xl-5 py-lg-3">
			...
			<div class="row mb-5">
					...
					<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
						...
						<div class="carousel-inner">
							<div class="carousel-item active">
								<img class="img-fluid" src="{{ asset('public/images/g1.jpg') }}" alt="First slide">
							</div>
							<div class="carousel-item">
								<img class="img-fluid" src="{{ asset('public/images/g4.jpg') }}" alt="Second slide">
							</div>
							<div class="carousel-item">
								<img class="img-fluid" src="{{ asset('public/images/g3.jpg') }}" alt="Third slide">
							</div>
						</div>
				...
				<div class="col-lg-5 aboutleft ml-xl-4">
					...
					<p class="border-left pl-3">Nulla auctor elit augue, eu volutpat risus tincidunt ullamcorper. Su spendisse id ante molestie libero placerat condimentum.
					</p>
	...
	<div class="team py-5" id="team">
		<div class="container py-xl-5 py-lg-3">
			<h3 class="title text-capitalize text-dark text-center pb-3 mb-sm-5 mb-4">Our Team
				<span></span>
			</h3>
				...
				<div class="col-lg-6 contact-left mt-lg-0 mt-5">
					<div class="w3l-agile ">
						<div class="address">
							...
							<p>345 Setwant Metropolitan, Italy.</p>
						</div>
	...
	<script src="{{ asset('public/js/car_services.js') }}"></script>
	<!-- banner text -->
	<script src="{{ asset('public/js/text.js') }}"></script>
	<!-- menu -->
	<script src="{{ asset('public/js/menu.js') }}"></script>
	<!-- lightbox -->
	<script src="{{ asset('public/js/smoothbox.jquery2.js') }}"></script>
